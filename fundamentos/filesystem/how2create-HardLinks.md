...
Observe o conteudo dos três arquivos criados. Execute os comandos:
```bash
cat notaA
cat notaB
cat notaC
...
ls -il nota[A-C]
``
O resualtado será semelhante a isso. Olhe atentamente a priemira e a segunda coluna:
```plaintext
